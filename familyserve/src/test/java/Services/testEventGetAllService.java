...
public class testEventGetAllService {
    ...
    public void testEventGetALl() {
        try{
            ...
            EventGetAllResponse expectedResponse = new EventGetAllResponse();
            EventModel[] input = new EventModel[2];
            input[0] = testEvent1;
            input[1] = testEvent3;
            expectedResponse.setSuccess(true);
            expectedResponse.setData(input);

            EventGetAllResponse outputResponse = myEventGetAllService.eventGetAll(testAuth1.getAuthToken());

            assertEquals(expectedResponse, outputResponse);


            EventGetAllResponse expectedBadResponse = new EventGetAllResponse();
            expectedBadResponse.setSuccess(false);
            expectedBadResponse.setMessage("no such authToken");

            EventGetAllResponse badOutputresponse = myEventGetAllService.eventGetAll("bugos");
